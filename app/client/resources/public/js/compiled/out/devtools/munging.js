...
var o44439 = temp__6736__auto__;
var temp__6736__auto____$1 = (o44439["core"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o44440 = temp__6736__auto____$1;
return (o44440["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__44361__auto__ = f;
return (o__44361__auto__["toString"]).call(o__44361__auto__);
} else {
return "";
}
}catch (e44441){var _ = e44441;
return "";
}});
...
try{var o__44361__auto___44443 = t;
(o__44361__auto___44443["cljs$lang$ctorPrWriter"]).call(o__44361__auto___44443,t,writer);
}catch (e44442){var __44444 = e44442;
}
...
var char_code = (function (){var o__44361__auto__ = (new String(char$));
return (o__44361__auto__["charCodeAt"]).call(o__44361__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__44361__auto__ = String;
return (o__44361__auto__["fromCharCode"]).call(o__44361__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__44445 = num_code;
switch (G__44445) {
case (1):
return (185);
...
var o__44361__auto__ = String;
return (o__44361__auto__["fromCharCode"]).call(o__44361__auto__,superscript_code);
});
/**
...
}catch (e44447){var _e__44368__auto__ = e44447;
return false;
}})())){
...
var vec__44448 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__44448,(0),null);
...
var or__32347__auto__ = (function (){var temp__6736__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__6736__auto__)){
...
if(cljs.core.truth_(temp__6736__auto__)){
var o44451 = temp__6736__auto__;
var temp__6736__auto____$1 = (o44451["dependencies_"]);
if(cljs.core.truth_(temp__6736__auto____$1)){
var o44452 = temp__6736__auto____$1;
return (o44452["nameToPath"]);
} else {
return null;
}
} else {
...
var len__33624__auto___44459 = arguments.length;
var i__33625__auto___44460 = (0);
while(true){
if((i__33625__auto___44460 < len__33624__auto___44459)){
args__33631__auto__.push((arguments[i__33625__auto___44460]));

var G__44461 = (i__33625__auto___44460 + (1));
i__33625__auto___44460 = G__44461;
continue;
} else {
}
break;
...
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__33632__auto__);
});

devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__44455){
var vec__44456 = p__44455;
var ns_detector = cljs.core.nth.call(null,vec__44456,(0),null);
var effective_detector = (function (){var or__32347__auto__ = ns_detector;
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
...
var G__44462 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__44463 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__44462;
remaining_tokens = G__44463;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq44453){
var G__44454 = cljs.core.first.call(null,seq44453);
var seq44453__$1 = cljs.core.next.call(null,seq44453);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__44454,seq44453__$1);
});
...
var vec__44467 = cljs.core.split_with.call(null,(function (p1__44466_SHARP_){
return cljs.core.not_EQ_.call(null,p1__44466_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__44467,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__44467,(1),null);
...
var vec__44470 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__44470,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__44470,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__44473 = cljs.core.rest.call(null,remaining_tokens);
var G__44474 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__44473;
name_tokens = G__44474;
continue;
} else {
...
var vec__44477 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__44477,(0),null);
var arity = cljs.core.nth.call(null,vec__44477,(1),null);
var vec__44480 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__44480,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__44480,(1),null);
var vec__44483 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__44483,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__44483,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__44483,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__44483,(3),null);
...
var vec__44489 = result;
var munged_ns = cljs.core.nth.call(null,vec__44489,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__44489,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__44489,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__44489,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__44489,(4),null);
var arity = cljs.core.nth.call(null,vec__44489,(5),null);
...
if(cljs.core.truth_(temp__6736__auto__)){
var vec__44493 = temp__6736__auto__;
var munged_name = cljs.core.nth.call(null,vec__44493,(0),null);
var args = cljs.core.nth.call(null,vec__44493,(1),null);
var vec__44496 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__44496,(0),null);
var name = cljs.core.nth.call(null,vec__44496,(1),null);
...
var G__44499 = (arity + (1));
var G__44500 = (function (){var temp__6736__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__6736__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__44501){
var vec__44502 = p__44501;
var arity = cljs.core.nth.call(null,vec__44502,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__44502,(1),null);
...
var fixed_arities = devtools.munging.collect_fn_fixed_arities.call(null,f,(function (){var or__32347__auto__ = max_fixed_arity;
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
...
return cljs.core.get.call(null,arities,p1__44505_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__44506_SHARP_){
return cljs.core.drop.call(null,(2),p1__44506_SHARP_);
...
var args__33631__auto__ = [];
var len__33624__auto___44513 = arguments.length;
var i__33625__auto___44514 = (0);
while(true){
if((i__33625__auto___44514 < len__33624__auto___44513)){
args__33631__auto__.push((arguments[i__33625__auto___44514]));

var G__44515 = (i__33625__auto___44514 + (1));
i__33625__auto___44514 = G__44515;
continue;
} else {
}
break;
...
var argseq__33632__auto__ = ((((1) < args__33631__auto__.length))?(new cljs.core.IndexedSeq(args__33631__auto__.slice((1)),(0),null)):null);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__33632__auto__);
});

devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__44509){
var vec__44510 = p__44509;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__44510,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq44507){
var G__44508 = cljs.core.first.call(null,seq44507);
var seq44507__$1 = cljs.core.next.call(null,seq44507);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__44508,seq44507__$1);
});
...
return devtools.munging.args_lists_to_strings.call(null,devtools.munging.arities_to_args_lists.call(null,(function (){var or__32347__auto__ = devtools.munging.collect_fn_arities.call(null,f);
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var and__32335__auto__ = include_ns_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?protocol_ns:null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_name)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_(include_protocol_ns_QMARK_)?".":null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(protocol_name)].join(''):null)),cljs.core.str.cljs$core$IFn$_invoke$arity$1(((!(cljs.core.empty_QMARK_.call(null,protocol_method)))?[cljs.core.str.cljs$core$IFn$_invoke$arity$1((cljs.core.truth_((function (){var or__32347__auto__ = include_protocol_ns_QMARK_;
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__44518__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__44518__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__44518__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__44518__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__44519 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__44519,(0),null);
var fn_name = cljs.core.nth.call(null,vec__44519,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__44519,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__44519,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__44519,(4),null);
var arity = cljs.core.nth.call(null,vec__44519,(5),null);
...
var protocol_part = (cljs.core.truth_((function (){var and__32335__auto__ = protocol_ns;
if(cljs.core.truth_(and__32335__auto__)){
return cljs.core.not.call(null,(function (){var and__32335__auto____$1 = silence_common_protocols_QMARK_;
...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__32347__auto__ = protocol_part;
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
return fn_part;
...
var o__44361__auto__ = f;
return (o__44361__auto__["getBasis"]).call(o__44361__auto__);
});
/**
...
if(cljs.core.truth_((function (){var and__32335__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__32335__auto__)){
...
}catch (e44523){var _e__44368__auto__ = e44523;
...
var G__44524 = (obj[cljs.core.first.call(null,path)]);
var G__44525 = cljs.core.rest.call(null,path);
obj = G__44524;
path = G__44525;
continue;
} else {
...
var partition_bits = (function (){var or__32347__auto__ = (obj[partition_key]);
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
return (0);
...
return (function (accum,p__44526){
var vec__44527 = p__44526;
var bit = cljs.core.nth.call(null,vec__44527,(0),null);
var protocol = cljs.core.nth.call(null,vec__44527,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__44530){
var vec__44531 = p__44530;
var ns = cljs.core.nth.call(null,vec__44531,(0),null);
var name = cljs.core.nth.call(null,vec__44531,(1),null);
var selector = cljs.core.nth.call(null,vec__44531,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__44536,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__44536,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__44536,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__44534_SHARP_){
return (obj[cljs.core.first.call(null,p1__44534_SHARP_)]);
});})(name,sorted_matches,vec__44536,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1525108941150
