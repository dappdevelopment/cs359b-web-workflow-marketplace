...
var G__45103 = devtools.prefs.pref.call(null,v);
v = G__45103;
continue;
} else {
return v;
...
var and__32335__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__32335__auto__){
var and__32335__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__32347__auto__ = (function (){try{if(!((value == null))){
...
}catch (e45106){var _e__44368__auto__ = e45106;
return false;
}})();
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
var or__32347__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e45110){var _e__44368__auto__ = e45110;
return false;
}})();
...
}catch (e45112){var _e__44368__auto__ = e45112;
return false;
}}
}
});
...
var and__32335__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__32335__auto____$1){
...
var or__32347__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
...
var and__32335__auto__ = (function (){var or__32347__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
...
var vec__45114 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__45114,(0),null);
var name = cljs.core.nth.call(null,vec__45114,(1),null);
...
var and__32335__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__32335__auto__)){
...
var or__32347__auto__ = typeof value === 'string';
if(or__32347__auto__){
return or__32347__auto__;
} else {
var or__32347__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__45117_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__45117_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1525108941639
