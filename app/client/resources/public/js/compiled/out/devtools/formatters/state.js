...
var len__33624__auto___45123 = arguments.length;
var i__33625__auto___45124 = (0);
while(true){
if((i__33625__auto___45124 < len__33624__auto___45123)){
args__33631__auto__.push((arguments[i__33625__auto___45124]));

var G__45125 = (i__33625__auto___45124 + (1));
i__33625__auto___45124 = G__45125;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__33632__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq45121){
var G__45122 = cljs.core.first.call(null,seq45121);
var seq45121__$1 = cljs.core.next.call(null,seq45121);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__45122,seq45121__$1);
});
...
return (p1__45126_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1525108941668
