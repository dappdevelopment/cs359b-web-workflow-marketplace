...
var len__33624__auto___45132 = arguments.length;
var i__33625__auto___45133 = (0);
while(true){
if((i__33625__auto___45133 < len__33624__auto___45132)){
args__33631__auto__.push((arguments[i__33625__auto___45133]));

var G__45134 = (i__33625__auto___45133 + (1));
i__33625__auto___45133 = G__45134;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__33632__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq45129){
var G__45130 = cljs.core.first.call(null,seq45129);
var seq45129__$1 = cljs.core.next.call(null,seq45129);
var G__45131 = cljs.core.first.call(null,seq45129__$1);
var seq45129__$2 = cljs.core.next.call(null,seq45129__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__45130,G__45131,seq45129__$2);
});
...
if(cljs.core.truth_((function (){var or__32347__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__33018__auto__,writer__33019__auto__,opt__33020__auto__){
return cljs.core._write.call(null,writer__33019__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__32335__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__32335__auto__){
var or__32347__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__45135_SHARP_){
return !((cljs.core.meta.call(null,p1__45135_SHARP_) == null));
})))){
...
var map__45136 = opts;
var map__45136__$1 = ((((!((map__45136 == null)))?((((map__45136.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45136.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45136):map__45136);
var markup_db = cljs.core.get.call(null,map__45136__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__32347__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e45140){var _e__44368__auto__ = e45140;
return false;
}})();
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
...
}catch (e45142){var _e__44368__auto__ = e45142;
return false;
}}
})())){
...
var _STAR_current_state_STAR_45144 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__45145 = opts;
var map__45145__$1 = ((((!((map__45145 == null)))?((((map__45145.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__45145.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__45145):map__45145);
var markup_db = cljs.core.get.call(null,map__45145__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_45144;
}});
...
;
var temp__6736__auto___45149 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__6736__auto___45149)){
var managed_print_level_45150 = temp__6736__auto___45149;
var _STAR_print_level_STAR_45148_45151 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_45150;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_45148_45151,managed_print_level_45150,temp__6736__auto___45149,writer,opts,job_fn){
return (function (p1__45147_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__45147_SHARP_,null);
});})(_STAR_print_level_STAR_45148_45151,managed_print_level_45150,temp__6736__auto___45149,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_45148_45151;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1525108941747
