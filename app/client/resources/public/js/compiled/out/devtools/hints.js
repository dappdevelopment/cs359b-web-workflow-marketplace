...
var reader = (function (){var or__32347__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__32347__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__32347__auto__)){
return or__32347__auto__;
} else {
return (128);
...
}catch (e46897){var _e = e46897;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__6736__auto___46900 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6736__auto___46900)){
var seen_errors_46901 = temp__6736__auto___46900;
if(cljs.core.truth_(seen_errors_46901.has(self))){
} else {
seen_errors_46901.add(self);

var temp__6738__auto___46902 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6738__auto___46902)){
var sense_46903 = temp__6738__auto___46902;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_46903)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1525108944635
