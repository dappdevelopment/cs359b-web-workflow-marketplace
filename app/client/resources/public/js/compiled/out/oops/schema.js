...
var G__36484 = cljs.core.first.call(null,element_str);
switch (G__36484) {
case "?":
arr.push((1));
...
var G__36486 = cljs.core.next.call(null,items);
items = G__36486;
continue;
} else {
return null;
...
var G__36487 = cljs.core.next.call(null,items);
items = G__36487;
continue;
} else {
return null;
...
var G__36489 = cljs.core.next.call(null,cljs.core.next.call(null,items));
items = G__36489;
continue;
} else {
return true;
...
switch (G__36492) {
case (0):
if(cljs.core.truth_(oops.schema.has_invalid_path_access_mode_QMARK_.call(null,path,((function (G__36492){
return (function (p1__36490_SHARP_){
return cljs.core.not_EQ_.call(null,p1__36490_SHARP_,(2));
});})(G__36492))
))){
...
return cljs.core.not_EQ_.call(null,p1__36491_SHARP_,(1));
});})(G__36492))
))){
...
//# sourceMappingURL=schema.js.map?rel=1525108930989
